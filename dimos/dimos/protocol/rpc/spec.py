...
class RPCClient(Protocol):
    ...
    def call_sync(
        ...
        if "start" in name or "on_system_modules" in name:
            rpc_timeout = 300.0  # starting modules can take longer
        elif "get_skills" in name:
            rpc_timeout = 30.0  # skill discovery typically takes 5-8s
